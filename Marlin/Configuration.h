...
#define STRING_CONFIG_H_AUTHOR "(inib, Michelangelo2208)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.165, 80.165, 399.2901, 415 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 40, 55 }
...
// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (64*60)
